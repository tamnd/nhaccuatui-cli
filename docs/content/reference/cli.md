...
```
nhaccuatui <command> [arguments] [flags]
```

Run `nhaccuatui <command> --help` for the full flag list on any command. This
...
per operation you declare in `nhaccuatui/domain.go`.
