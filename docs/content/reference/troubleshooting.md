...
Most of these come down to network reality or how nhaccuatui serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

nhaccuatui rate-limits like any public site. nhaccuatui already paces
...
Where a surface is gated, nhaccuatui reads a cookie or token you supply
...
`nhaccuatui`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what nhaccuatui actually did
